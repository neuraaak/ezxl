...
The `docs.yml` workflow automatically builds and deploys **ezxl** documentation to GitHub Pages using **MkDocs Material**. The documentation is served at `https://neuraaak.github.io/ezxl/`.
...
- Triggers when files are modified in:
  ...
  - `ezxl/**` - Source code (for auto-generated API docs)
...
│       ├── index.md
│       ├── ezxl.md                   # ::: ezxl.ezxl.YourProject
│       ├── printer.md                # ::: ezxl.handlers.console.EzPrinter
│       ├── logger.md                 # ::: ezxl.handlers.file.EzLogger
│       ├── wizard.md                 # ::: ezxl.handlers.wizard.core.RichWizard
│       ├── configuration.md          # ::: ezxl.config.manager.ConfigurationManager
│       ├── types.md                  # ::: ezxl.types (LogLevel, Pattern)
│       └── exceptions.md             # ::: ezxl.core.exceptions
├── cli/
...
1. **Visit documentation**: <https://neuraaak.github.io/ezxl/>
...
# Check specific page
mkdocs serve
# Navigate to http://127.0.0.1:8000/api/reference/ezxl/
```
...
1. Check that the module path in `docs/api/reference/*.md` is correct:
   ...
   ```markdown
   ::: ezxl.ezxl.YourProject # Must match actual module path
   ```
...
2. Verify the package installs correctly:
   ...
   ```bash
   pip install -e .
   python -c "from ezxl.ezxl import YourProject"
   ```
...
- **Preview URL**: <https://neuraaak.github.io/ezxl/>
...
site_url: https://neuraaak.github.io/ezxl/
theme:
  name: material
  features:
    - navigation.tabs
...
- **Live documentation**: <https://neuraaak.github.io/ezxl/>
